...
class Ui_Valuation_Expert(QtWidgets.QMainWindow):
	...
	def fillRowWithStone(self,res,weight_metal,weight_diamond):
		...
		self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,6).setText(str(format(rate*res[7]*weight_metal/240,'.3f')))
	...
	def fillRowWithoutStone(self,res,weight):
		...
		self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,6).setText(str(format(rate*res[7]*weight/240,'.3f')))
		self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,7).setText(str(res[8]))
		...
		self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,11).setText(str(format(rate*res[7]*weight/240,'.3f')))
		self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,12).lineEdit().setText(res[6])
		self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,13).lineEdit().setText(str(res[3]))
		self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,14).lineEdit().setText(str(res[10]))
		self.autoUpdateTotals()
	...
	def ValuateGold2(self):
		if(self.radioButton_5.isChecked()):
			if(self.checkBox_4.isChecked()==0):
				...
				while(len(l)!=qty):
					if(time.time()>timeout):
						...
						self.tableWidget_2.setRowCount(0)
						np.random.seed(None)
						# QtWidgets.QMessageBox.warning(self, 'Error', np.random.seed())
				...
				while(len(l)!=qty):
					...
					weights=[]
					for i in range(qty):
						a=(weights_diamond[i],weights_gold[i])
						weights.append(a)
			...
			if(self.checkBox_4.isChecked()==0):
				...
				# Amount=int(self.lineEdit_54.text())
				diamond_wt=int(self.lineEdit_55.text())
				qty=int(self.lineEdit_59.text())
				gold_rate=float(self.lineEdit_48.text())
				diamond_rate=float(self.lineEdit_51.text())

				gold_amount=((diamond_wt*diamond_rate)*0.25)
		...
		if(self.radioButton_5.isChecked()):
			if(self.checkBox_3.isChecked()==0):
				...
				while(len(l)!=qty):
					...
					weights=[]
					for i in range(qty):
						a=(weights_diamond[i],weights_silver[i])
						weights.append(a)
			...
			if(self.checkBox_3.isChecked()==0):
				...
				# Amount=int(self.lineEdit_54.text())
				diamond_wt=int(self.lineEdit_56.text())
				qty=int(self.lineEdit_60.text())
				silver_rate=float(self.lineEdit_49.text())
				diamond_rate=float(self.lineEdit_51.text())

				silver_amount=((diamond_wt*diamond_rate)*0.25)
	...
	def ValuatePlatinum2(self):
		if(self.radioButton_5.isChecked()):
			if(self.checkBox_2.isChecked()==0):
				...
				platinum_wt=(platinum_amount)/(platinum_rate/1000)
				l=[]
				# t1=time.time()
				while(len(l)!=qty):
				...
				while(len(l)!=qty):
					...
					weights=[]
					for i in range(qty):
						a=(weights_diamond[i],weights_platinum[i])
						weights.append(a)
			...
			if(self.checkBox_2.isChecked()==0):
				...
				# Amount=int(self.lineEdit_54.text())
				diamond_wt=int(self.lineEdit_57.text())
				qty=int(self.lineEdit_61.text())
				platinum_rate=float(self.lineEdit_50.text())
				diamond_rate=float(self.lineEdit_51.text())
	...
	def autoRate(self):
		...
		if(res is None):
			self.tableWidget_2.cellWidget(self.curr_row,1).setText(self.lineEdit.text())
			self.tableWidget_2.cellWidget(self.curr_row,12).lineEdit().setText('Gold')
		else:
			if(res[0]=='Platinum'):
				self.tableWidget_2.cellWidget(self.curr_row,1).setText(self.lineEdit_3.text())
				self.tableWidget_2.cellWidget(self.curr_row,12).lineEdit().setText(res[0])
			elif(res[0]=='Silver'):
				self.tableWidget_2.cellWidget(self.curr_row,1).setText(self.lineEdit_2.text())
				self.tableWidget_2.cellWidget(self.curr_row,12).lineEdit().setText(res[0])
			else:
				self.tableWidget_2.cellWidget(self.curr_row,1).setText(self.lineEdit.text())
				self.tableWidget_2.cellWidget(self.curr_row,12).lineEdit().setText(res[0])
	...
	def autoStoneWeight(self):
		...
		self.tableWidget_2.cellWidget(self.curr_row,8).setText(str(gross-metal))
	...
	def autoValue(self):
		...
		if(metal=='Gold' or metal=='Platinum'):
			...
			value=(purity*rate*wt)
		self.tableWidget_2.cellWidget(self.curr_row,6).setText(str(value))
		self.autoTotal()
		self.autoUpdateTotals()
	...
	def autoStoneRate(self):
		...
		if(s_name=='Diamond'):
			self.tableWidget_2.cellWidget(self.curr_row,9).setText(self.lineEdit_4.text())
	...
	def autoStoneValue(self):
		...
		value=wt*rate
		self.tableWidget_2.cellWidget(self.curr_row,10).setText(str(value))
		self.autoUpdateTotals()
	...
	def autoTotal(self):
		...
		self.tableWidget_2.cellWidget(self.curr_row,11).setText(str(total))
		self.autoUpdateTotals()
	...
	def autoItemRateWise(self,a):
		...
		if(a=='Quantitywise'):
			...
			self.tableWidget_2.cellWidget(self.curr_row,6).setText(str(metal_value*quantity))
			self.autoTotal()
			self.autoUpdateTotals()
		else:
			self.autoValue()
	...
	def autoUpdateTotals(self):
		...
		for i in range(self.tableWidget_2.rowCount()):
			...
			if(self.tableWidget_2.cellWidget(i,7).text()=='Diamond'):
				stone_qt=silver_qt+int(self.tableWidget_2.cellWidget(i,3).text())
				stone_gross=silver_gross+float(self.tableWidget_2.cellWidget(i,4).text())
				# silver_metal=silver_metal+float(self.tableWidget_2.cellWidget(i,5).text())
				stone_value=silver_value+float(self.tableWidget_2.cellWidget(i,6).text())
	...
	def deleteRow(self):
		...
		self.tableWidget_2.removeRow(self.tableWidget_2.item(self.tableWidget_2.currentRow()))
		# self.tableWidget_2.setRowCount(self.curr_row-1)
    ...
    def ReturnCustomer(self):
        ...
        res=self.cursor.fetchone()
        print(res[0])
        self.lineEdit_67.setText(res[12])
        self.lineEdit_68.setText(str(res[13]))
		self.lineEdit_69.setText(res[14])
    ...
    def ReturnValuation(self):
		...
		if(res[10]=='Amount'):
			self.radioButton_5.setChecked()
		elif(res[10]=='Weight'):
			self.radioButton_6.setChecked()
		else:
	...
	def fillRates(self):
		...
		try:
			...
			self.cursor.execute(sql_command)
			res=self.cursor.fetchone()
			self.lineEdit_49.setText(str(res[3]))
			self.lineEdit_50.setText(str(res[4]))
			self.lineEdit_51.setText(str(res[5]))
			self.lineEdit_52.setText(str(res[6]))
			self.lineEdit_53.setText(str(res[7]))
		except:
	...
	def new_btn(self):
		...
		C_Name=self.lineEdit_67.text()
		C_Pan=self.lineEdit_68.text()
		C_Address=self.lineEdit_69.text()
	...
	def Document(self):
		...
		doc.render(context)
		filename="generated_doc"+str(id)+".docx"
		doc.save(filename)
		print('SUCCESS')
		QtWidgets.QMessageBox.information(self, 'Success', 'Report Created')
...
#********************************************************************************************  
	...
	#                     self.createRow()
	#                     self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,0).setText(res[1])
	#                     self.tableWidget_2.cellWidget(self.tableWidget_2.rowCount()-1,1).setText(silver_rate)
