...
class Ui_Selection(QtWidgets.QMainWindow):
    ...
    def onTableClicked(self,text):
        format_str='''UPDATE TABLE Popup SET Row={text};'''
        sql_command=format_str.format(text=text)
        self.cursor.execute(sql_command)
        self.connection.commit()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.itemActivated[str].connect(self.onTableClicked)
